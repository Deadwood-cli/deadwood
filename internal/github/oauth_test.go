...
func TestResolveClientIDIgnoresEnvByDefault(t *testing.T) {
...
func TestResolveClientIDAllowsEnvOverride(t *testing.T) {
	t.Setenv(EnvClientID, "env-override-id")

	id, err := ResolveClientID(true)
